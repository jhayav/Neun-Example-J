...
if (strcmp(target, "N1M") == 0) {
    ...
    I_cgc = 0.0;
    c_min = 0.0;  c_max = 0.15;  n_ramp_steps = 20;
    ramp_target = 4;
  } else {
  ...
  // =================== SINAPSIS CPG ===================
  Synapse::ConstructorArgs s_args;

  s_args.params[Synapse::esyn]=0.0; s_args.params[Synapse::gsyn]=0.077;
  s_args.params[Synapse::tau_syn]=200.0; s_args.params[Synapse::v_pre]=-67.0;
  s_args.params[Synapse::v_r]=-40.0; s_args.params[Synapse::dec_slope]=2.5;
  Synapse s_n1m_n2v(n1m,Neuron::v,n2v,Neuron::v,s_args,1);

  s_args.params[Synapse::esyn]=-90.0; s_args.params[Synapse::gsyn]=50.0;
  s_args.params[Synapse::tau_syn]=50.0;
  Synapse s_n2v_n1m(n2v,Neuron::v,n1m,Neuron::v,s_args,1);

  s_args.params[Synapse::gsyn]=0.5;
  Synapse s_n1m_n3t(n1m,Neuron::v,n3t,Neuron::v,s_args,1);

  s_args.params[Synapse::gsyn]=8.0;
  Synapse s_n3t_n1m(n3t,Neuron::v,n1m,Neuron::v,s_args,1);

  s_args.params[Synapse::gsyn]=2.0;
  Synapse s_n2v_n3t(n2v,Neuron::v,n3t,Neuron::v,s_args,1);

  s_args.params[Synapse::gsyn]=8.0;
  Synapse s_n2v_so(n2v,Neuron::v,so,Neuron::v,s_args,1);

  s_args.params[Synapse::esyn]=0.0; s_args.params[Synapse::gsyn]=4.0;
  s_args.params[Synapse::tau_syn]=200.0;
  Synapse s_so_n1m(so,Neuron::v,n1m,Neuron::v,s_args,1);

  s_args.params[Synapse::gsyn]=1.0;
  Synapse s_so_n2v(so,Neuron::v,n2v,Neuron::v,s_args,1);

  // =================== SINAPSIS CGC ===================
  CGCSynapse::ConstructorArgs cargs;
  cargs.params[Synapse::v_pre]=-67.0; cargs.params[Synapse::v_r]=-40.0;
  cargs.params[Synapse::dec_slope]=2.5;

  cargs.params[Synapse::esyn]=-9.0; cargs.params[Synapse::gsyn]=3.0;
  cargs.params[Synapse::tau_syn]=175.0;
  CGCSynapse s_cgc_n1m(cgc,CGCNeuron::v,n1m,Neuron::v,cargs,1);

  cargs.params[Synapse::esyn]=-1.0; cargs.params[Synapse::gsyn]=0.0;
  cargs.params[Synapse::tau_syn]=345.0;
  CGCSynapse s_cgc_n2v(cgc,CGCNeuron::v,n2v,Neuron::v,cargs,1);

  cargs.params[Synapse::esyn]=10.0; cargs.params[Synapse::gsyn]=0.0;
  cargs.params[Synapse::tau_syn]=142.0;
  CGCSynapse s_cgc_so(cgc,CGCNeuron::v,so,Neuron::v,cargs,1);

  cargs.params[Synapse::esyn]=-2.0; cargs.params[Synapse::gsyn]=1.0;
  cargs.params[Synapse::tau_syn]=164.0;
  CGCSynapse s_cgc_n3t(cgc,CGCNeuron::v,n3t,Neuron::v,cargs,1);
